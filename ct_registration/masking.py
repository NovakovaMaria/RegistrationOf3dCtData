...
Produces a binary mask isolating the sandstone specimen from the
background air, and an eroded version that avoids edge/interpolation
artefacts.
"""
...
def create_specimen_mask(volume: np.ndarray,
    ...
    mask = volume > best_thresh
    print(f"  Otsu threshold = {best_thresh:.4f}, "
